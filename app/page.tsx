...
const services = [
  {
    image: "/service1.png",
    title: "ขนส่งหิน–ทราย",
    desc: "ขนส่งหิน ทราย และวัสดุก่อสร้างถึงหน้างานอย่างเป็นระบบ เหมาะสำหรับไซต์ก่อสร้าง โรงงาน โครงการ และลูกค้าประจำที่ต้องการความต่อเนื่อง",
    upload: "service1.png",
  },
  {
    image: "/service2.png",
    title: "งานโครงการ",
    desc: "วางแผนรถสำหรับงานโครงการที่ต้องใช้รถหลายคัน คุมรอบงาน ลดเวลารอหน้างาน และประสานงานให้เดินงานต่อเนื่อง",
    upload: "service2.png",
  },
  {
    image: "/service3.png",
    title: "อู่ซ่อมบำรุง",
    desc: "มีอู่ซ่อมบำรุงภายใน ดูแลความพร้อมของรถก่อนออกงาน ลดความเสี่ยงรถเสียกลางทาง และช่วยให้งานส่งมอบไม่สะดุด",
    upload: "service3.png",
  },
  {
    image: "/service4.png",
    title: "ติดตาม GPS",
    desc: "ติดตามรถด้วย GPS เพื่อดูสถานะ ประสานงานรอบรถ และเพิ่มความมั่นใจให้ลูกค้าเห็นความเคลื่อนไหวของงานได้ชัดเจน",
    upload: "service4.png",
  },
  {
    image: "/service5.png",
    title: "ทีมประสานงาน",
    desc: "ทีมงานประสานงานระหว่างลูกค้า คนขับ และหน้างาน ช่วยแก้ปัญหาเฉพาะหน้า ลดความคลาดเคลื่อน และทำให้งานจบไวขึ้น",
    upload: "service5.png",
  },
  {
    image: "/service6.png",
    title: "ท่าทราย",
    desc: "มีท่าทรายรองรับงานวัสดุ คัดสรรคุณภาพและจัดรอบขนส่งได้สะดวก เหมาะกับงานก่อสร้าง งานถม และงานที่ต้องการวัสดุต่อเนื่อง",
    upload: "service6.png",
  },
];
    ...
    <main className="page">
      ...
      <section id="home" className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-desc">
            SAMAINIYOM KHONSONG ให้บริการขนส่งหิน ทราย และวัสดุก่อสร้างสำหรับงานจริงหน้างาน
            ด้วยรถสิบล้อกว่า 100 คัน วางแผนรอบรถเป็นระบบ ติดตามด้วย GPS ทุกคัน
            พร้อมทีมประสานงานและอู่ซ่อมบำรุงภายใน เพื่อให้งานส่งมอบต่อเนื่อง ตรงเวลา และตรวจสอบได้
          </p>
      ...
      <section id="services" className="section">
        <div className="section-head">
          ...
          <p className="section-desc">บริการหลักของบริษัทออกแบบมาเพื่อรองรับงานหน้างานจริง ตั้งแต่วัสดุ รถขนส่ง การประสานงาน ไปจนถึงการติดตามสถานะ เพื่อให้ลูกค้าทำงานต่อได้อย่างมั่นใจ</p>
        </div>
      ...
      <section id="about" className="section">
        <div className="section-head">
          ...
          <p className="section-desc">สมัยนิยม ขนส่ง คือผู้ให้บริการขนส่งหิน–ทรายที่เข้าใจงานก่อสร้างจริง เน้นรถพร้อม ทีมพร้อม และข้อมูลชัดเจน เพื่อให้ลูกค้าคุมต้นทุน เวลา และความต่อเนื่องของงานได้ดีขึ้น</p>
        </div>
        <div className="about-wrap">
          <div className="about-panel">
            <img src="/logo.png" alt="SAMAINIYOM KHONSONG" className="about-logo-large" />
            <h3>SAMAINIYOM KHONSONG</h3>
            <p>เราให้บริการขนส่งหิน ทราย และวัสดุก่อสร้างครบวงจร โดยมีรถสิบล้อในระบบจำนวนมาก ทีมประสานงาน ระบบติดตามรถ และอู่ดูแลรถภายใน เพื่อให้ลูกค้าได้รับบริการที่ต่อเนื่อง ตรวจสอบได้ และพร้อมรองรับงานขนาดใหญ่</p>
          </div>
      ...
      <section id="owner" className="section owner-section">
        ...
        <div className="owner-card">
          ...
          <div className="owner-content">
            ...
            <h4 className="owner-name">คุณอาคม สมัยนิยม</h4>
            <span className="owner-role">Owner / ผู้บริหารสมัยนิยม ขนส่ง</span>
            <p>
              ภายใต้การดูแลของคุณอาคม สมัยนิยม เราให้ความสำคัญกับงานขนส่งที่ตรวจสอบได้ รถพร้อมใช้งาน
              ทีมงานประสานงานชัดเจน และมาตรฐานการส่งมอบที่ลูกค้าไว้วางใจได้ในทุกเที่ยวงาน
            </p>
